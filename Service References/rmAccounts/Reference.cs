...
namespace eChandanCanteen.rmAccounts {
    using System.Data;
    ...
    public interface Accounts_WebServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eChandanCanteen.rmAccounts.Form_SalesPDFResponse Form_SalesPDF(eChandanCanteen.rmAccounts.Form_SalesPDFRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eChandanCanteen.rmAccounts.Asset_PurBillUploadResponse Asset_PurBillUpload(eChandanCanteen.rmAccounts.Asset_PurBillUploadRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eChandanCanteen.rmAccounts.tr_RadiologyRegistrationResponse tr_RadiologyRegistration(eChandanCanteen.rmAccounts.tr_RadiologyRegistrationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://exprohelp.com/BillPaymentChecking", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Data.DataSet BillPaymentChecking(out string processInfo, string unit_id, string ref_by, string dFrom, string dTo);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eChandanCanteen.rmAccounts.App_Info_InsertResponse App_Info_Insert(eChandanCanteen.rmAccounts.App_Info_InsertRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eChandanCanteen.rmAccounts.DownloadFileResponse DownloadFile(eChandanCanteen.rmAccounts.DownloadFileRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        eChandanCanteen.rmAccounts.TransferDocumentsResponse TransferDocuments(eChandanCanteen.rmAccounts.TransferDocumentsRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Accounts_WebServiceSoapChannel : eChandanCanteen.rmAccounts.Accounts_WebServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Accounts_WebServiceSoapClient : System.ServiceModel.ClientBase<eChandanCanteen.rmAccounts.Accounts_WebServiceSoap>, eChandanCanteen.rmAccounts.Accounts_WebServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eChandanCanteen.rmAccounts.Form_SalesPDFResponse eChandanCanteen.rmAccounts.Accounts_WebServiceSoap.Form_SalesPDF(eChandanCanteen.rmAccounts.Form_SalesPDFRequest request) {
            return base.Channel.Form_SalesPDF(request);
        }
        
        public byte[] Form_SalesPDF(System.Data.DataSet ds, string FromTo) {
            eChandanCanteen.rmAccounts.Form_SalesPDFRequest inValue = new eChandanCanteen.rmAccounts.Form_SalesPDFRequest();
            inValue.ds = ds;
            inValue.FromTo = FromTo;
            eChandanCanteen.rmAccounts.Form_SalesPDFResponse retVal = ((eChandanCanteen.rmAccounts.Accounts_WebServiceSoap)(this)).Form_SalesPDF(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eChandanCanteen.rmAccounts.Asset_PurBillUploadResponse eChandanCanteen.rmAccounts.Accounts_WebServiceSoap.Asset_PurBillUpload(eChandanCanteen.rmAccounts.Asset_PurBillUploadRequest request) {
        ...
        public string Asset_PurBillUpload(string eqNo, string extension, byte[] data, string login_id, out string processInfo) {
            eChandanCanteen.rmAccounts.Asset_PurBillUploadRequest inValue = new eChandanCanteen.rmAccounts.Asset_PurBillUploadRequest();
            inValue.eqNo = eqNo;
            inValue.extension = extension;
            inValue.data = data;
            inValue.login_id = login_id;
            eChandanCanteen.rmAccounts.Asset_PurBillUploadResponse retVal = ((eChandanCanteen.rmAccounts.Accounts_WebServiceSoap)(this)).Asset_PurBillUpload(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eChandanCanteen.rmAccounts.tr_RadiologyRegistrationResponse eChandanCanteen.rmAccounts.Accounts_WebServiceSoap.tr_RadiologyRegistration(eChandanCanteen.rmAccounts.tr_RadiologyRegistrationRequest request) {
        ...
        public string tr_RadiologyRegistration(string patient_id, string report_history, string Investigation, string workTable, decimal totalsize, string fileName, byte[] data) {
            eChandanCanteen.rmAccounts.tr_RadiologyRegistrationRequest inValue = new eChandanCanteen.rmAccounts.tr_RadiologyRegistrationRequest();
            ...
            inValue.data = data;
            eChandanCanteen.rmAccounts.tr_RadiologyRegistrationResponse retVal = ((eChandanCanteen.rmAccounts.Accounts_WebServiceSoap)(this)).tr_RadiologyRegistration(inValue);
            return retVal.tr_RadiologyRegistrationResult;
        }
        
        public System.Data.DataSet BillPaymentChecking(out string processInfo, string unit_id, string ref_by, string dFrom, string dTo) {
            return base.Channel.BillPaymentChecking(out processInfo, unit_id, ref_by, dFrom, dTo);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eChandanCanteen.rmAccounts.App_Info_InsertResponse eChandanCanteen.rmAccounts.Accounts_WebServiceSoap.App_Info_Insert(eChandanCanteen.rmAccounts.App_Info_InsertRequest request) {
        ...
        public string App_Info_Insert(string unit_id, int app_Head_Id, string remark, string asset_no, int lst_reading, int cur_reading, decimal amount, string login_id, string doc_name, byte[] data, out string processInfo) {
            eChandanCanteen.rmAccounts.App_Info_InsertRequest inValue = new eChandanCanteen.rmAccounts.App_Info_InsertRequest();
            ...
            inValue.data = data;
            eChandanCanteen.rmAccounts.App_Info_InsertResponse retVal = ((eChandanCanteen.rmAccounts.Accounts_WebServiceSoap)(this)).App_Info_Insert(inValue);
            processInfo = retVal.processInfo;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eChandanCanteen.rmAccounts.DownloadFileResponse eChandanCanteen.rmAccounts.Accounts_WebServiceSoap.DownloadFile(eChandanCanteen.rmAccounts.DownloadFileRequest request) {
            return base.Channel.DownloadFile(request);
        }
        
        public byte[] DownloadFile(string Path, out string processInfo) {
            eChandanCanteen.rmAccounts.DownloadFileRequest inValue = new eChandanCanteen.rmAccounts.DownloadFileRequest();
            inValue.Path = Path;
            eChandanCanteen.rmAccounts.DownloadFileResponse retVal = ((eChandanCanteen.rmAccounts.Accounts_WebServiceSoap)(this)).DownloadFile(inValue);
            processInfo = retVal.processInfo;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        eChandanCanteen.rmAccounts.TransferDocumentsResponse eChandanCanteen.rmAccounts.Accounts_WebServiceSoap.TransferDocuments(eChandanCanteen.rmAccounts.TransferDocumentsRequest request) {
        ...
        public string TransferDocuments(string Doc_date, string Division, string Unit_Id, string FinYear, string FileType, string FileName, byte[] data, out string msg) {
            eChandanCanteen.rmAccounts.TransferDocumentsRequest inValue = new eChandanCanteen.rmAccounts.TransferDocumentsRequest();
            ...
            inValue.FileName = FileName;
            inValue.data = data;
            eChandanCanteen.rmAccounts.TransferDocumentsResponse retVal = ((eChandanCanteen.rmAccounts.Accounts_WebServiceSoap)(this)).TransferDocuments(inValue);
            msg = retVal.msg;
